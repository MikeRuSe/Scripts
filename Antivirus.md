...
Clear-Host
    ...
    Write-Host "                 " -NoNewline;Write-Host " Presione '3' para analizar una carpeta y sus archivos (aparecerán cosas en rojo...)" -ForegroundColor Magenta
